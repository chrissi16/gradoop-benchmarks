...
import org.gradoop.temporal.model.impl.operators.metric.MinDegreeEvolution;
...
/**
 * Dedicated program to benchmark the min degree evolution operator. The benchmark is expected to be executed on
 * a temporal graph dataset.
 */
public class MinDegreeEvolutionBenchmark extends BaseTpgmBenchmark {
   ...
   * <p>
   * Example: {@code $ /path/to/flink run -c org.gradoop.benchmarks.tpgm.MinDegreeEvolutionBenchmark
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, MinDegreeEvolutionBenchmark.class.getName());
    ...
    // init the operator
    MinDegreeEvolution operator = new MinDegreeEvolution(degreeType, timeDimension);
    ...
    env.execute(MinDegreeEvolutionBenchmark.class.getSimpleName()+ " (" + degreeType + "," + timeDimension + "," +
