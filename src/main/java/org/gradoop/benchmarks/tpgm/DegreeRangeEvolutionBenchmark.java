...
import org.gradoop.temporal.model.impl.operators.metric.DegreeRangeEvolution;
...
/**
 * Dedicated program to benchmark the degree range evolution operator. The benchmark is expected to be executed on
 * a temporal graph dataset.
 */
public class DegreeRangeEvolutionBenchmark extends BaseTpgmBenchmark {
   ...
   * <p>
   * Example: {@code $ /path/to/flink run -c org.gradoop.benchmarks.tpgm.DegreeRangeEvolutionBenchmark
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, DegreeRangeEvolutionBenchmark.class.getName());
    ...
    // init the operator
    DegreeRangeEvolution operator = new DegreeRangeEvolution(degreeType, timeDimension);
    ...
    env.execute(DegreeRangeEvolutionBenchmark.class.getSimpleName()+ " (" + degreeType + "," + timeDimension + "," +
