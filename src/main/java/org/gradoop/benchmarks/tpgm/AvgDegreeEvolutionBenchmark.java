...
import org.gradoop.temporal.model.impl.operators.metric.AvgDegreeEvolution;
...
/**
 * Dedicated program to benchmark the avg degree evolution operator. The benchmark is expected to be executed on
 * a temporal graph dataset.
 */
public class AvgDegreeEvolutionBenchmark extends BaseTpgmBenchmark {
   ...
   * <p>
   * Example: {@code $ /path/to/flink run -c org.gradoop.benchmarks.tpgm.AvgDegreeEvolutionBenchmark
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, AvgDegreeEvolutionBenchmark.class.getName());
