...
import org.gradoop.temporal.model.impl.operators.metric.DegreeVarianceEvolution;
...
/**
 * Dedicated program to benchmark the degree variance evolution operator. The benchmark is expected to be executed on
 * a temporal graph dataset.
 */
public class DegreeVarianceEvolutionBenchmark extends BaseTpgmBenchmark {
   ...
   * <p>
   * Example: {@code $ /path/to/flink run -c org.gradoop.benchmarks.tpgm.DegreeVarianceEvolutionBenchmark
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, DegreeVarianceEvolutionBenchmark.class.getName());
    ...
    // init the operator
    DegreeVarianceEvolution operator = new DegreeVarianceEvolution(degreeType, timeDimension);
